import{_ as l,W as c,X as d,Z as s,$ as e,a0 as a,Y as i,D as r}from"./framework-1800c995.js";const o={},t={href:"https://misskey-hub.net/docs/install.html",target:"_blank",rel:"noopener noreferrer"},p=s("h2",{id:"方針",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#方針","aria-hidden":"true"},"#"),e(" 方針")],-1),v={href:"https://hub.docker.com/r/misskey/misskey",target:"_blank",rel:"noopener noreferrer"},m=i(`<h2 id="準備" tabindex="-1"><a class="header-anchor" href="#準備" aria-hidden="true">#</a> 準備</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /opt/services/misskey
$ <span class="token function">sudo</span> <span class="token function">chown</span> <span class="token variable">\${<span class="token environment constant">USER</span>}</span>:docker /opt/services
